...
app.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function($stateProvider, $urlRouterProvider, $locationProvider) {
  ...
  $stateProvider
    .state('painel', {
        ...
        templateUrl:"app/views/painel.html"
    })
    .state('calendario', {
        url: '/calendario',
        controller: 'jogosCtrl',
        templateUrl:"app/views/informacoesdotime/calendario/jogos.html"
    })
    .state('jogadores', {
        url: '/informacoesdotime/jogadores',
        controller: 'jogadoresCtrl',
        templateUrl:"app/views/informacoesdotime/jogadores/jogadores.html"
    })
    .state('negociacao', {
        url: '/gerenciamento/negociacao',
        templateUrl:"app/views/gerenciamento/negociacao/negociacao.html"
    })
    .state('procurarjogador', {
        url: '/gerenciamento/negociacao/buscaavancada',
        controller: 'procujogadorCtrl',
        templateUrl:"app/views/gerenciamento/negociacao/buscaavancada/procurarjogador.html"
    })
    .state('planodejogo', {
        url: '/gerenciamento/planodejogo',
        controller: 'planodejogoCtl',
        templateUrl:"app/views/gerenciamento/planodejogo/planodejogo.html"
    })
    .state('infodacompeticao', {
        url: '/basededados/infodacompeticao/',
        templateUrl:"app/views/basededados/infodacompeticao/infcompeticao.html"
    })
    .state('campeonatobrasileiro', {
        url: '/basededados/infodacompeticao/campeonatobrasileiro',
        controller: 'campeonatoBrasileiroCtrl',
        templateUrl:"app/views/basededados/infodacompeticao/campeonatobrasileiro/campeonatobrasileiro.html"
    });
...
app.factory('DadosJson', function($http) { 
    function getJogadores(){
       return $http.get('backend/dados/jogador.json').then(function(data) {
            return data.data;
        }); 
    } 
...
app.service('getJson', function($http){
  this.dadosJogador = function() {
    return $http.get('backend/dados/jogador.json');
  }
  this.dadosEquipes = function() {
    return $http.get('backend/dados/equipes.json');
  }
  this.dadosCampeonato = function() {
    return $http.get('backend/dados/campeonatos.json');
  }

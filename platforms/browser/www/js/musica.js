app.controller('musicaCtrl', function($scope, $http,$location, $stateParams, getJson) {
  ...
  //       "artist": "Wilkinson",
  //       "artwork": "images/PES-2016.jpg",
  //       "source": "dados/musicas/Wilkinson_-_Afterglow_PES2015.mp3",
  //       "length": "3:24",
  //       "star": "4",
  //       "price": "1.29"
  // }];

  // $http({ method: 'GET', url: 'dados/musicas/'  }).then(function successCallback(response) {
  //   $(response.data).find("td > a").each(function(){
  //         $scope.tempData.push($(this).attr("href"));
  //   });

  //   var caminhodoemp3 = "dados/musicas/";
  //    angular.forEach($scope.tempData, function(item, $index){
  //        if($index != 0){
  //           novaTrack.push({"song": item, "artist": "Trilha Sonora", "artwork": "images/PES-2016.jpg",
